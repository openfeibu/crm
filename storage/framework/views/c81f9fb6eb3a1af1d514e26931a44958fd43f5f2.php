<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans('app.edit')); ?><?php echo e(trans('mail_template.name')); ?></cite></a>
        </div>
    </div>
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('mail_template/'.$mail_template->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <script type="text/plain" id="content" name="content" style="width:1000px;height:240px;">
                                <?php echo $mail_template->content; ?>
