                ...
                <form class="layui-form" action="<?php echo e(guard_url('goods/'.$goods->id)); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" autocomplete="off" placeholder="" lay-verify="required"  class="layui-input" value="<?php echo e($goods->name); ?>" >
                        </div>
                    </div>
                    <div class="layui-form-item fb-form-item2">
                        <label class="layui-form-label"><?php echo e(trans('goods.label.purchase_price')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="goods_purchase_price" autocomplete="off" placeholder="" class="layui-input" value="<?php echo e($goods->purchase_price); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item fb-form-item2">
                        <label class="layui-form-label"><?php echo e(trans('goods.label.selling_price')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="goods_selling_price" autocomplete="off" placeholder="" class="layui-input" value="<?php echo e($goods->selling_price); ?>">
                        </div>
                    </div>
                    <?php if($goods->attribute_id && $attribute): ?>
                        <div class="layui-form-item fb-form-item2">
