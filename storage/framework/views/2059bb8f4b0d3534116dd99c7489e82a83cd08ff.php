    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'email',title:'<?php echo e(trans('salesman.label.email')); ?>',edit:'text'}
                ...
                ,{field:'ig',title:'<?php echo e(trans('salesman.label.ig')); ?>',edit:'text'}
                ,{field:'imessage',title:'<?php echo e(trans('salesman.label.imessage')); ?>',edit:'text'}
                ,{field:'mobile',title:'<?php echo e(trans('salesman.label.mobile')); ?>',edit:'text'}
                ,{field:'monthly_performance_target',title:'<?php echo e(trans('salesman.label.monthly_performance_target')); ?>',edit:'text'}
                ,{field:'yearly_performance_target',title:'<?php echo e(trans('salesman.label.yearly_performance_target')); ?>',edit:'text'}
                ,{field:'customer_count',title:'<?php echo e(trans('salesman.label.customer_count')); ?>',width:'120'}
                ,{field:'new_customer_count',title:'<?php echo e(trans('salesman.label.new_customer_count')); ?>',width:'120'}
                ,{field:'today_new_customer_count',title:'<?php echo e(trans('salesman.label.today_new_customer_count')); ?>',width:'150'}
                ,{field:'yesterday_new_customer_count',title:'<?php echo e(trans('salesman.label.yesterday_new_customer_count')); ?>',width:'150'}
