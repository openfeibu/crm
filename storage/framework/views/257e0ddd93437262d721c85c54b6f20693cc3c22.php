<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite><?php echo e(trans('app.add')); ?><?php echo e(trans('mail_account.name')); ?></cite></a>
        </div>
    </div>
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('mail_account')); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <select name="host" lay-filter="checkBox">
                                <?php $__currentLoopData = trans('mail_account.host'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $host): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($host); ?>"><?php echo e($host); ?></option>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <select name="port" lay-filter="checkBox">
                                <?php $__currentLoopData = trans('mail_account.port'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $port): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($port); ?>"><?php echo e($port); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="from_name" lay-verify="required" autocomplete="off" placeholder="请输入<?php echo e(trans('mail_account.label.from_name')); ?>" class="layui-input" value="<?php echo e(config('model.mail.mail_account.from_name')); ?>">
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">
                            <select name="encryption" lay-filter="checkBox">
                                <?php $__currentLoopData = trans('mail_account.encryption'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $encryption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($encryption); ?>"><?php echo e($encryption); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
