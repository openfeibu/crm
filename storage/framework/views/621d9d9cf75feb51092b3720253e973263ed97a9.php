    ...
    layui.use(['jquery','element','form','table','echarts'], function(){
        ...
        (function (){
            ...
            function ajax_trading() {
                ...
                $.get('<?php echo e(guard_url("statistic/trading")); ?>?date_type='+date_type+'&salesman_id='+salesman_id).done(function (data) {
                    trading.hideLoading();
                    // 填入数据
                    trading.setOption({
                        xAxis: {
        ...
        (function (){
            ...
            var hot_goods_list = <?php echo json_encode($hot_goods_list); ?>
        ...
        (function (){
            ...
            var this_month_hot_goods_list = <?php echo json_encode($this_month_hot_goods_list); ?>
