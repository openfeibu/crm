                ...
                <form class="layui-form" action="" lay-filter="fb-form">
                    <div class="layui-block mb10">
                        <div class="layui-inline tabel-btn">
                            <button class="layui-btn layui-btn-warm "  type="button"><a href="<?php echo e(guard_url('new_customer/create')); ?>"><?php echo e(trans('app.add')); ?> <?php echo e(trans('new_customer.name')); ?></a></button>
                            <button class="layui-btn layui-btn-warm "  type="button"><a href="<?php echo e(guard_url('new_customer_import')); ?>">批量上传</a></button>
                    ...
                    <div class="layui-block table-search mb10">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">过滤空<?php echo e(trans('new_customer.label.email')); ?></label>
                            <input type="checkbox" class="search_key" name="email_not_null" placeholder="过滤空<?php echo e(trans('new_customer.label.email')); ?>" lay-skin="switch" lay-text="ON|OFF" value="0" lay-filter="email_not_null">
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">过滤空<?php echo e(trans('new_customer.label.mobile')); ?></label>
                            <input type="checkbox" class="search_key" name="mobile_not_null" placeholder="过滤空<?php echo e(trans('new_customer.label.mobile')); ?>" lay-skin="switch" lay-text="ON|OFF" value="0" lay-filter="email_not_null">
                        </div>
                        <div class="layui-inline">
    ...
    <form class="layui-form send_mail_form" action="" style="margin: 10px 10px ">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php $__currentLoopData = $mailAccountRepository->orderBy('id','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <?php $__currentLoopData = $mailTemplateRepository->orderBy('id','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'salesman_name',title:'<?php echo e(trans('salesman.label.name')); ?>', width:120,sort:true}
...
<script>
    layui.use(['jquery','element','table'], function() {
        ...
        active.download = function () {
            ...
            var data_id_obj = {};
            var i = 0;
            var url = '<?php echo e(guard_url('new_customer_download')); ?>';
            var paramStr = "";
        ...
        active.download_email_excel = function () {
            ...
            var data_id_obj = {};
            var i = 0;
            var url = '<?php echo e(guard_url('new_customer_download_email_excel')); ?>';
            var paramStr = "";
            data.forEach(function(v){
                if(i == 0)
                {
