                    ...
                    layer.confirm('以下操作：', {
                        ...
                        ,btn3: function(){
                            layer.prompt({
                                ...
                                var load = layer.load();
                                $.ajax({
                                    url : "<?php echo e(guard_url('category/decrement_price')); ?>",
                                    data : {'price':value,'category_id':id,'_token':"<?php echo csrf_token(); ?>"},
                                    type : 'POST',
                        ...
                        layer.prompt({
                            ...
                            var load = layer.load();
                            $.ajax({
                                url : "<?php echo e(guard_url('category/increment_price')); ?>",
                                data : {'price':value,'category_id':id,'_token':"<?php echo csrf_token(); ?>"},
                                type : 'POST',
                                success : function (data) {
                                    layer.close(load);
