    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                ...
                <div class="layui-inline">
                    <input class="layui-input search_key" name="name" id="demoReload" placeholder="<?php echo e(trans('goods.label.name')); ?>" autocomplete="off">
                </div>
                <div class="layui-inline">
...
<script>
    var attribute_main_url = "<?php echo e(guard_url('goods_attribute_value')); ?>";
    var main_url = "<?php echo e(guard_url('goods')); ?>";
    var delete_all_url = "<?php echo e(guard_url('goods/destroy_list')); ?>";
    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'goods_name',title:'<?php echo e(trans('goods.name')); ?>',width:420}
                ,{field:'attribute_value',title:'<?php echo e(trans('attribute.name')); ?>'}
        ...
        table.on('edit(fb-table)', function(obj){
            ...
            var load = layer.load();
            $.ajax({
                url : "<?php echo e(guard_url('goods/update_attribute')); ?>",
                data : ajax_data,
                type : 'POST',
                success : function (data) {
                    layer.close(load);
            ...
            del:function(){
                ...
                data.length == 0 ?
                        ...
                        layer.confirm('是否删除已选择的数据',{title:'提示'},function(index){
                            ...
                            $.ajax({
                                url : delete_all_url,
                                data :  {'list_ids':data_id_obj,'_token' : "<?php echo csrf_token(); ?>"},
                                type : 'POST',
                                success : function (data) {
                                    layer.close(load);
                                    if(data.code == 0)
