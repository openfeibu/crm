                ...
                <form class="layui-form" action="<?php echo e(guard_url('category/'.$category->id)); ?>" method="post" lay-filter="fb-form">
                        ...
                        <div class="layui-input-block">
                            ...
                            <select name="attribute_id" id="attribute_id">
                                ...
                                <?php $__currentLoopData = $attributeRepository->orderBy('id','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($attribute['id']); ?>" <?php if($attribute->id == $category->attribute_id): ?> selected <?php endif; ?>><?php echo $attribute['name']; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-inline">
                            <input name="weight" value="<?php echo e($category->weight); ?>" class="layui-input layui-input-inline">
                        </div>
