                ...
                <div class="goods_list">
                    <table class="layui-table" lay-filter="cart" id="cart">
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'attribute_value'}"><?php echo e(trans('goods.label.size')); ?></th>
                ...
                <div class="fb-main-table">
                    <form class="layui-form" action="" lay-filter="fb-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <p class="input-p" id="purchase_price"><?php echo e($order['purchase_price']); ?></p>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="tracking_number" id="tracking_number" autocomplete="off" placeholder="请输入<?php echo e(trans('order.label.tracking_number')); ?>" class="layui-input" value="<?php echo e($order->tracking_number); ?>" lay-verify="required">
                            </div>
                        </div>
                        <?php endif; ?>
                        <?php if($order->payment_sn): ?>
                        <div class="layui-form-item">
                            <label class="layui-form-label"><?php echo e(trans('order.label.payment_sn')); ?></label>
                            <div class="layui-input-inline">
                                <input type="text" name="payment_sn" id="payment_sn" autocomplete="off" placeholder="请输入<?php echo e(trans('order.label.payment_sn')); ?>" class="layui-input" value="<?php echo e($order->payment_sn); ?>" lay-verify="required">
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="layui-form-item">
                            <label class="layui-form-label"><?php echo e(trans('order.label.admin_remark')); ?></label>

                            <div class="layui-input-inline">
                                <textarea name="admin_remark" id="admin_remark" placeholder="请输入<?php echo e(trans('order.label.admin_remark')); ?>" class="layui-textarea"><?php echo e($order->admin_remark); ?></textarea>
                            </div>
...
<script>
    layui.use(['element',"table",'form',"jquery"], function(){
        ...
        form.on('submit(submit_btn)', function(data){
            ...
            var ajax_data = {'_token':"<?php echo csrf_token(); ?>",customer_id:customer_id,address:address,salesman_id:salesman_id,'carts':tableData,tracking_number:tracking_number,payment_sn:payment_sn,admin_remark:admin_remark};
            var load = layer.load();
            $.ajax({
