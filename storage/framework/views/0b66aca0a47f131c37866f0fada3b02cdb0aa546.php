            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('new_customer/'.$new_customer->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="company_name" autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.company_name')); ?>" class="layui-input" value="<?php echo e($new_customer->company_name); ?>">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <textarea name="remark" id="remark" placeholder="请输入 <?php echo e(trans('new_customer.label.remark')); ?>" class="layui-textarea"><?php echo $new_customer->remark; ?></textarea>
                        </div>
                    </div>
