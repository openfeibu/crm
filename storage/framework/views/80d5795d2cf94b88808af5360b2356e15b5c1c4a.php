            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('salesman')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="en_name" value="<?php echo e($salesman->en_name); ?>" lay-verify="required"  autocomplete="off" placeholder="请输入<?php echo e(trans("salesman.label.en_name")); ?>" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="monthly_performance_target" placeholder="请输入<?php echo e(trans("salesman.label.monthly_performance_target")); ?>" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
