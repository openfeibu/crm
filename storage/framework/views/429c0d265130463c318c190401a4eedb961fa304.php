    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('new_customer')); ?>" method="post" lay-filter="fb-form">
                        ...
                        <div class="layui-input-block">
                            <select name="mark" lay-filter="checkBox" lay-verify="required">
                                <?php $__currentLoopData = trans('new_customer.mark'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"><?php echo e($mark); ?></option>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ig"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.ig')); ?>" class="layui-input check_exist">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ig_follower_count"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.ig_follower_count')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ig_sec"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.ig_sec')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="email" id="email" autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.email')); ?>" class="layui-input check_exist">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="nickname" autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.nickname')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="mobile"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.mobile')); ?>" class="layui-input check_exist">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="whatsapp" id="whatsapp"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.whatsapp')); ?>" class="layui-input check_exist">
                        </div>
                    </div>
                    <div class="layui-form-item fb-form-item2">
                        <label class="layui-form-label"><?php echo e(trans('new_customer.label.imessage')); ?></label>
                        <div class="layui-input-block">
                            <input type="text" name="imessage"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.imessage')); ?>" class="layui-input check_exist">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="facebook"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.facebook')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="company_website"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.company_website')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="company_name" autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.company_name')); ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item fb-form-item2">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="main_product"  autocomplete="off" placeholder="请输入 <?php echo e(trans('new_customer.label.main_product')); ?>" class="layui-input">
                        </div>
                    </div>
        ...
        $('.check_exist').blur(function(){
            ...
            if(value)
            {
                ...
                $.ajax({
                    ...
                    data : {'token': "<?php echo csrf_token(); ?>", 'field':field,'value':value},
                    type : 'get',
